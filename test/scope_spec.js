...
describe('Scope', function() {
  ...
  describe("digest", function() {
    ...
    it('ends the digest when the last watch is clean', function(){
      ...
      scope.$digest();
      //becase the first is dirty, so digest each watch is run twice!
    ...
    it('it passes the second $eval argument straight throught',function(){
      scope.aValue = 42;
    ...
    it('executes $evalAsync\'ed function later in the same cycle', function(){
      ...
      scope.$watch(
        function(scope){ return scope.aValue; },
        function(newValue, oldValue, aValue){
    ...
    it('coalesces many calls to $applyAsync', function(done){
      ...
      scope.$watch(
        ...
        function(neValue, oldValue, scope) { }
      );
    ...
    it('cancels and flushes $appplyAsync if digested first', function(done){
      scope.counter = 0;
